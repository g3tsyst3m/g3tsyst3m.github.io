...
After you've successfully completed coding all of that glorious x64 assembly code, it's time to compile it and get your shellcode.  Go ahead and do that and you should be presented with the following shellcode.  I formatted mine for a more aesthetically pleasing presentation 😸
...
This is the de facto shellcode that downloads and executes, funny enough, more shellcode (a reverse shell) LOL.  It's a shellcode loader in and of itself!  Now, let's transfer this to our direct syscall based c++ code to load it up and work some magic!
