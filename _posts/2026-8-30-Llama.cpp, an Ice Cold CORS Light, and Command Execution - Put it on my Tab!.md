...
{% include zoom-img.html src="https://github.com/user-attachments/assets/6ba6e9ff-add3-4f6b-8469-b0ab16fc359e" alt="llama-server log line denying the cross-origin request" %}

We get the same result if we manually configure a specific allowed origin, which is what I would recommend anyway:

{% include zoom-img.html src="https://github.com/user-attachments/assets/2e3dd6f8-bf65-48c6-843d-9209a652de4d" alt="llama-server output showing CORS restricted to http://localhost:8080" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/ebbb6268-f049-4dd4-a0c8-c8a9eb88cb86" alt="Bookmarklet creation in browser bookmarks bar" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/8ca0fff3-9563-4e3f-a633-223c4eb61716" alt="llama-server Web UI loaded in browser at localhost:8080" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/20435be0-96ca-4396-8047-6fb29ab93f53" alt="Bookmarklet being clicked in the browser tab with llama-server UI" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/7d6be731-a734-462c-a5fd-901b8f9dc8bf" alt="Agent UI replacing the llama Web UI after bookmarklet execution" %}

{% include zoom-img.html src="https://github.com/user-attachments/assets/f57f6473-028c-4f05-96d6-36c443b3e8ed" alt="Agent UI showing tool execution results (whoami output)" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/e03d2832-c9b3-4fca-a56e-8531a4e8ca93" alt="Windows shortcut properties showing the --load-extension target path" %}
...
{% include zoom-img.html src="https://github.com/user-attachments/assets/ef454a5a-8f33-499a-8dea-3d083a5846cf" alt="Brave browser launching with the injected extension replacing the llama UI" %}
...
📹 In-Depth Video/Audio Walkthrough for today's blog post: [Video](https://ko-fi.com/s/e2226bdb1f)
